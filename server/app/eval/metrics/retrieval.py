...
#  retrieval:
#     - recall     # Misst, wie viele relevante Chunks in den Top-K Ergebnissen gefunden wurden
#     - ndcg       # Misst Ranking-Qualität mit gradierter Relevanz (0-3 Skala)
#     - mrr        # Misst, wie früh der erste relevante Chunk gefunden wird
...
def mrr_at_k(ranked_ids: List[str], gold_ids: Set[str], k: int) -> float:
    ...
    #         return 1.0 / idx
    # return 0.0
    raise NotImplementedError("mrr_at_k is not implemented yet")
...
def _dcg(rels: List[int], k: int) -> float:
    ...
    # return dcg
    raise NotImplementedError("_dcg is not implemented yet")
...
def compute_retrieval_metrics(
    ...
    # return res
    raise NotImplementedError("compute_retrieval_metrics is not implemented yet")
